...
struct FamiliarDetailView: View {
    ...
    var body: some View {
        Form {
            ...
            // --- HAPPINESS ---
            Section(header: Text("Happiness")) {
                HStack {
                    // Text("Happiness") // --- THIS LINE IS REMOVED TO FIX THE DUPLICATION ---
                    Spacer()
                    ProgressView(value: familiar.happiness, total: 1.0)
                        .progressViewStyle(LinearProgressViewStyle(tint: .green))
                        .frame(width: 150) // Increased width for better look
